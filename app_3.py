...
ax.fill_between(forecast["ds"], forecast["yhat_lower"], forecast["yhat_upper"], color="yellow", alpha=0.2, label="Prediction Interval")
...
# 힌트:
ax2.plot(merged["ds"], merged["residual"], label="Residual", color="green")
